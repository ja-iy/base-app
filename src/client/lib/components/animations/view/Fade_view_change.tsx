...
interface Fade_View_ChangeProps {
...
export default function Fade_View_Change({once, className, style, no_fade, no_fade_in, from, from_len, len, config, t, easing, bind, changeOn, children}:Fade_View_ChangeProps){
